...
-- Add any missing fields to customers table if needed
...
-- Update RLS policies for account_applications to allow users to create applications
CREATE POLICY IF NOT EXISTS "Users can update their applications" ON account_applications
FOR UPDATE USING (
  EXISTS (
