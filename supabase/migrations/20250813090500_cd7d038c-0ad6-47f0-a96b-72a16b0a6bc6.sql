-- Create sample applications data for dashboards using existing or generic user IDs

-- Clear existing sample data first
DELETE FROM applications WHERE id LIKE '%-aaaa-bbbb-cccc-%';

-- Add sample applications with various statuses and roles
-- Using generic user IDs that may or may not exist (the dashboard will still work)
INSERT INTO applications (
  ...
  -- User applications (using sample UUIDs)
...
-- Add some sample profiles for role counting in the dashboard
...
-- Add some managers and partners for the dashboard to work properly
