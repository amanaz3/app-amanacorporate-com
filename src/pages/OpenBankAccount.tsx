          ...
          <div className="flex items-center justify-between min-h-[44px]">
            ...
            <nav className="hidden md:flex items-center" role="navigation" aria-label="Main navigation">
              ...
              >
                ...
                <a 
                  href="https://amanacorporate.com/partners"
                  type="button" 
                  data-state="off" 
                  role="radio" 
                  aria-checked="false" 
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <a 
                      href="mailto:info@amanacorporate.com" 
                      className="flex items-center gap-3 text-sm text-muted-foreground hover:text-primary transition-colors group"
                    >
                      <div className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center group-hover:bg-primary/20 transition-colors">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="text-center md:text-left">
                  ...
                  <div className="flex gap-3 justify-center md:justify-start">
                    <a 
                      href="https://ae.linkedin.com/company/amanacorporate" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="w-10 h-10 bg-background rounded-lg flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 border border-border/50 transition-all duration-200" 
                      aria-label="LinkedIn"
                    >
                    ...
                    <a 
                      href="https://x.com/CorporateAmana" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="w-10 h-10 bg-background rounded-lg flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 border border-border/50 transition-all duration-200" 
                      aria-label="Twitter"
                    ...
                    <a 
                      href="https://www.facebook.com/AMANACorporateService" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="w-10 h-10 bg-background rounded-lg flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 border border-border/50 transition-all duration-200" 
                      aria-label="Facebook"
                    ...
                    <a 
                      href="https://www.instagram.com/amanacorporate/" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="w-10 h-10 bg-background rounded-lg flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 border border-border/50 transition-all duration-200" 
