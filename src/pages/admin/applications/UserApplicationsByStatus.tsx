...
const UserApplicationsByStatus = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">User Applications - {statusTitle}</h1>
          <p className="text-muted-foreground">
            Manage user applications with {status} status
          </p>
        </div>
      </div>
...
export default UserApplicationsByStatus;