...
const PartnerApplicationsByStatus = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Partner Applications - {statusTitle}</h1>
          <p className="text-muted-foreground">
            Manage partner applications with {status} status
          </p>
        </div>
      </div>
              ...
              <TableBody>
                {applications.map((application) => (
                  <TableRow key={application.id}>
                    ...
                    <TableCell>{application.assigned_manager || 'Unassigned'}</TableCell>
...
export default PartnerApplicationsByStatus;