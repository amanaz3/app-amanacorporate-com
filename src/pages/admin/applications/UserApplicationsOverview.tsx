...
const UserApplicationsOverview = () => {
  const statusConfig = [
    { 
      status: 'draft', 
      label: 'Draft', 
      ...
      description: 'Applications in draft state'
    },
    { 
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Overview of all user applications by status - {totalApplications} total applications
          </p>
        </div>
      </div>
            ...
            <Card key={config.status} className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <Button 
                  ...
                  asChild
                >
                  <Link to={`/admin/users/applications/${config.status}`}>
                    View {config.label}
                  </Link>
                </Button>
              </CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>User application statistics</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Latest user application updates</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm">John Doe's application was completed</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm">New application submitted by Jane Smith</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm">Application needs more information</p>
...
export default UserApplicationsOverview;