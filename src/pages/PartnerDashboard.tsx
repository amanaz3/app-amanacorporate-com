...
const PartnerDashboard = () => {
  ...
  const statusCards = [
    ...
    },
    {
      ...
      description: 'Requested by Manager'
    },
    {
      title: 'Return',
      value: stats.return,
    ...
    },
    {
      ...
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
      description: 'Sent to assigned Manager'
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Manage your customer and referral applications</p>
        </div>

        {/* Application Status Overview */}
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold">My Customer / Referral Applications</h2>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Button onClick={() => navigate('/partners/signup')} className="h-auto py-4 flex flex-col items-center">
              <Plus className="h-6 w-6 mb-2" />
              Create New Customer / Referral Application
            </Button>
            <Button onClick={() => navigate('/partners/draft')} variant="outline" className="h-auto py-4 flex flex-col items-center">
              <Save className="h-6 w-6 mb-2" />
              Save Draft
            </Button>
            <Button onClick={() => navigate('/partners/submit')} variant="outline" className="h-auto py-4 flex flex-col items-center">
          ...
          <CardContent>
            {recentApplications.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">Start by creating your first customer application.</p>
                <Button 
                  onClick={() => navigate('/partners/signup')} 
                  className="mt-4"
                >
                  Create Application
                </Button>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                You'll receive notifications here when your manager updates application status or requests additional information.
              </p>
            </div>
          </CardContent>
        </Card>
